...
Q_value_lookup = np.ones((param_disc, param_disc)) * 10.0 # Arbitrary initialization
...
def update_loop(loop_object, all_states, current_state_index, time_step):
	...
	Q_value_lookup[loop_object.param_1, loop_object.param_2] = np.clip(loop_object.sample(time_step), -10, 10)
...
def action_selection():
	...
	# print()
	return param_1_idx, param_2_idx
